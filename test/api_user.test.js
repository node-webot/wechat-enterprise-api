...
describe('user', function () {
  ...
  it('getAuthorizeURL should ok', function () {
    ...
    expect(url).to.be('https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx4e2c2b771c467c9f&redirect_uri=http%3A%2F%2Fbaidu.com%2Fcallback&response_type=code&scope=snsapi_base&state=#wechat_redirect');
  });
});
